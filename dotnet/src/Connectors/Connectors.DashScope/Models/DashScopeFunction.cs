...
/// <summary>
/// Represents a function that can be passed to the DashScope API
/// </summary>
public sealed class DashScopeFunction
{
    ...
    internal DashScopeTool.FunctionDeclaration ToFunctionDeclaration()
    {
        ...
        return new DashScopeTool.FunctionDeclaration
        {

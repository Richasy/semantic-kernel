...
/// </summary>
internal static class SparkPluginCollectionExtensions
{
    /// <summary>
    /// Given an <see cref="SparkFunctionToolCall"/> object, tries to retrieve the corresponding <see cref="KernelFunction"/>
    /// and populate <see cref="KernelArguments"/> with its parameters.
    /// </summary>
    /// <param name="plugins">The plugins.</param>
    /// <param name="functionToolCall">The <see cref="SparkFunctionToolCall"/> object.</param>
    ...
    public static bool TryGetFunctionAndArguments(
        ...
        SparkFunctionToolCall functionToolCall,
